...
Route::get('owner-dash', [OwnerDashController::class, 'index'])->name('ownerdash');

    /** Routes PARCELLES & PROPERTIES: Start **/

Route::get('/owner-parcelles', [OwnerDashController::class, 'get_parcelles'])->name('owner_parcelles');
Route::get('/owner-houses', [OwnerDashController::class, 'get_houses'])->name('owner_properties');
Route::get('/owner-add-parcelle', [OwnerDashController::class, 'get_add_parcelle'])->name('owner_addparcelle');
Route::get('/owner-add-house', [OwnerDashController::class, 'get_add_house'])->name('owner_addhouse');
Route::get('/owner-edit-parcelle{id}', [OwnerDashController::class, 'edit_parcelle'])->name('owner_editparcelle');
Route::get('/owner-edit-house{id}', [OwnerDashController::class, 'edit_house'])->name('owner_edithouse');

    /** Routes PARCELLES & PROPERTIES: END **/
