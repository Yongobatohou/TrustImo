                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        ...
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <div class="d-flex flex-column flex-lg-row align-items-center">
                                <a class="btn btn-outline-primary py-3 px-4 rounded-pill" href="{{route('register')}}" target="_blank">Inscrivez-vous sur TrustImo dès maintenant!!!</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 fadeInRight wow" data-wow-delay="0.5s">
                        ...
                        <div class="masthead-device-mockup">
                            <img src="../assets/img/Screen-app.webp" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 fadeInLeft wow">
                        ...
                        <div class="masthead-device-mockup">
                            ...
                            <img src="../assets/img/home-illus-01.png" class="img-fluid" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <!-- Mashead text and app badges-->
                        <div class="mb-5 mb-lg-0 text-center text-lg-start">
                            ...
                            <div class="d-flex flex-column flex-lg-row align-items-center ">
                                <a class="nav-link btn btn-primary p-3" href="{{route('register')}}">Utiliser TrustImo</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="position-relative overflow-hidden">
                                        <a href="{{route('properties.details', [$property, 'slug' => $property->getSlug()])}}">
                                            <img class="img-fluid" src="../storage/{{$property->image}}" alt="">
                                        </a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="property-item rounded overflow-hidden">
                                ...
                                <div class="p-4 pb-0">
                                    ...
                                    <p><small class="flex-fill text-center fw-bolder border-end py-2"><i class="fa fa-ruler-combined text-primary me-2"></i>{{$parcelle->surface}} m²</small> </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center justify-content-center justify-content-lg-between">
                    <div class="col-12 col-lg-5">
                        ...
                        <div class="align-items-center col-md-12 mt-4 p-3" style="background-color: #befad9; border: solid 1px #befad9; border-radius:10px; width:auto;">
                            <p  style="font-size:23px;">Agent immobilier ou Propriétaire ??</p>
                            <a class="text-success" href="{{route('pro')}}" style="text-decoration:underlined; font-size:23px;">Diffuser vos annonces sur TrustImo</a>
                        </div>
                    </div>
        ...
        <section class="cta pt-5 bg-white mt-5">
            <div class="cta-content pb-5 mt-5">
                <div class="container px-2">
                    <h2 class="text-dark display-3 lh-1 mb-4">
                        N'hésitez plus Utilisez TrustImo pour trouver votre confort!!!
                    </h2>
                    <a class="btn btn-outline-primary py-3 px-4 rounded-pill" href="{{route('register')}}" target="_blank">Utiliser gratuitement TrustImo</a>
                </div>
            </div>
        </section>
