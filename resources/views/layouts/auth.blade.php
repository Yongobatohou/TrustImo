...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light shadow-md accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link hover {{request()->is('agences') ? ' text-white bg-green bg-opacity-75 p-3' : 'hover:bg-green-500 hover:bg-opacity-75 p-3 hover:text-white'}}" href="{{route('get_agences')}}">
                ...
                <a class="nav-link hover {{request()->is('administrateurs') ? ' text-white bg-green bg-opacity-75 p-3' : 'hover:bg-green-500 hover:bg-opacity-75 p-3 hover:text-white'}}" href="{{route('get_admins')}}">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link hover {{request()->is('demandes') ? ' text-white bg-green bg-opacity-75 p-3' : 'hover:bg-green hover:bg-opacity-75 p-3 hover:text-white'}}" href="#">
